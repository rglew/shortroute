...
var graph = routes.convertGraph(
	cityList,
	routes.loadGraph("./input/graph.txt")
);
var result;
...
module.exports.runTests = function() {
	...
	console.log(
		routes.recodeRoutes(
			cityList,
			routes.calcRoute(cityList, graph, ["A", "B", "C"])
		)
	);
	...
	console.log(
		routes.recodeRoutes(
			cityList,
			routes.calcRoute(cityList, graph, ["A", "D"])
		)
	);
	...
	console.log(
		routes.recodeRoutes(
			cityList,
			routes.calcRoute(cityList, graph, ["A", "D", "C"])
		)
	);
	console.log(
		"\x1b[36m",
	...
	console.log(
		routes.recodeRoutes(
			cityList,
			routes.calcRoute(cityList, graph, ["A", "E", "B", "C", "D"])
		)
	);
	...
	console.log(
		routes.recodeRoutes(
			cityList,
			routes.calcRoute(cityList, graph, ["A", "E", "D"])
		)
	);
	console.log(
		"\x1b[36m",
	...
	result = routes.recodeRoutes(
		cityList,
		routes.paths({ graph, from: 2, to: 2 })
	);
	console.log(
	...
	result = routes.recodeRoutes(
		cityList,
		routes.paths({ graph, from: 0, to: 2 })
	);
	console.log(
		result.filter(function(elem) {
